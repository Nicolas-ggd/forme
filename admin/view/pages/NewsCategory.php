                        ...
                        <div class="container-fluid">
                            <div class="row">
                                <div class="col-12">
                                    <div class="card">
                                        <div class="card-header">
                                            <h3 class="card-title">კატეგორიების თეიბლი</h3>
                                        </div>
                                        ...
                                        <div class="card-body">
                                            <div class="d-flex align-items-center justify-content-between">
                                                <div class="">
                                                    <a href="?action=addNewCategory"
                                                       class="btn btn-outline-info my-2 btn-rounded">კატეგორიების დამატება</a>
                                                    ...
                                                    <div class="col-sm-12">
                                                        <form id="table_form">
                                                            ...
                                                            <table id="example2"
                                                                ...
                                                                if (isset($_POST))
                                                                    foreach ($newsCategory as $i => $category) { ?>
                                                                        ...
                                                                        <tr class="odd">
                                                                            <td class="dtr-control sorting_1"
                                                                                ...
                                                                                <div class="d-flex">
                                                                                    <div class="chk ms-3 d-flex align-items-center">
                                                                                        ...
                                                                                        <p class="fw-bold px-1 align-items-center d-flex m-0"><?php echo $category['id']; ?></p>
                                                                            ...
                                                                            <td>
                                                                                <div class="d-flex align-items-center">
                                                                                    <div class="ms-3">
                                                                                        <p class="fw-bold mb-1"><?php echo $category['news_category']; ?></p>
                                                                                        <p class="text-muted mb-0"></p>
                                                                                    </div>
                                                                                </div>
                                                                            </td>
                                                                            ...
                                                                            <td>
                                                                                <a href="?action=editNewCategory&category_id=<?php echo $category['id']; ?>"
                                                                                   id="edit_line"
