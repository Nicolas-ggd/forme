                        ...
                        <div class="container-fluid">
                            <div class="row">
                                <div class="col-12">
                                    <div class="card">
                                        <div class="card-header">
                                            <h3 class="card-title">უფლებების თეიბლი</h3>
                                        </div>
                                        ...
                                        <div class="card-body">
                                            <div class="d-flex align-items-center justify-content-between">
                                                <div class="">
                                                    <a href="?action=addPermision"
                                                       class="btn btn-outline-info my-2 btn-rounded">უფლებების დამატება</a>
                                                    ...
                                                    <div class="col-sm-12">
                                                        <form id="table_form">
                                                            ...
                                                            <table id="example2"
                                                                ...
                                                                if (isset($_POST))
                                                                    foreach ($userPermision as $i => $permision) { ?>
                                                                        ...
                                                                        <tr class="odd">
                                                                                ...
                                                                                <div class="d-flex">
                                                                                    <div class="chk ms-3 d-flex align-items-center">
                                                                                        <input class="check_box"
                                                                                               ...
                                                                                               value="<?php echo $permision['id']; ?>">
                                                                                        <p class="fw-bold px-1 align-items-center d-flex m-0"><?php echo $permision['id']; ?></p>
                                                                            ...
                                                                            <td>
                                                                                <div class="d-flex align-items-center">
                                                                                    <div class="ms-3">
                                                                                        <p class="fw-bold mb-1"><?php echo $permision['user_permision']; ?></p>
                                                                                        <p class="text-muted mb-0"></p>
                                                                                    </div>
                                                                                </div>
                                                                            </td>
                                                                            ...
                                                                            <td>
                                                                                <a href="?action=editPermision&permision_id=<?php echo $permision['id']; ?>"
                                                                                   id="edit_line"
...
<script src="/public/js/UserPermision.js"></script>
