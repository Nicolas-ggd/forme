                        ...
                        <div class="card card-primary">
                            ...
                            <div class="card-body">
                                ...
                                <form method="post" id="add_form">
                                    ...
                                    if(isset($permision_id)){
                                        echo '<input type="hidden" class="form-control" name="permision_id" value="' . $permision_id . '" id="permision_id">';
                                    }

                                    ?>
                                    <div class="form-group">
                                        <label for="inputName">უფლება</label>
                                        <input type="text" id="permision" name="user_permision" class="form-control"
                                               value="<?php echo isset($permision) ? $permision['user_permision'] : ''; ?>">
                                    </div>

                                    <button type="submit" class="btn btn-success" id="send" name="add_form" form="add_form">
                                        გაგზავნა
                                    </button>
                                    <a href="?action=permision" class="btn btn-warning" >უკან</a>
