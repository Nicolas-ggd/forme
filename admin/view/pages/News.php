                        ...
                        <div class="container-fluid">
                            <div class="row">
                                <div class="col-12">
                                    <div class="card">
                                        <div class="card-header">
                                            <h3 class="card-title">სიახლეების თეიბლი</h3>
                                        </div>
                                        ...
                                        <div class="card-body">
                                            <div class="d-flex align-items-center justify-content-between">
                                                <div class="">
                                                    <a href="?action=addNews"
                                                       class="btn btn-outline-info my-2 btn-rounded">სიახლეების დამატება</a>
                                                                        ...
                                                                        <tr class="odd">
                                                                            <td class="dtr-control sorting_1"
                                                                                ...
                                                                                <div class="d-flex">
                                                                                    <div class="chk ms-3 d-flex align-items-center">
                                                                                        ...
                                                                                        <p class="fw-bold px-1 align-items-center d-flex m-0"><?php echo $new['id']; ?></p>
                                                                            ...
                                                                            <td>
                                                                                <div class="d-flex align-items-center">
                                                                                    <div class="ms-3">
                                                                                        <p class="fw-bold mb-1"><?php echo $new['news_title']; ?></p>
                                                                                        <p class="text-muted mb-0"></p>
                                                                                    </div>
                                                                                </div>
                                                                            </td>
                                                                            <td>
                                                                                <div class="d-flex align-items-center">
                                                                                    <div class="ms-3">
                                                                                        <p class="fw-bold mb-1"><?php echo $new['news_desc']; ?></p>
                                                                                        <p class="text-muted mb-0"></p>
                                                                                    </div>
                                                                                </div>
                                                                            </td>
                                                                            <td>
                                                                                <div class="d-flex align-items-center">
                                                                                    <div class="ms-3">
                                                                                        <p class="fw-bold mb-1"><?php echo $new['news_image']; ?></p>
                                                                                        <p class="text-muted mb-0"></p>
                                                                                    </div>
                                                                                </div>
                                                                            </td>
                                                                            <td>
                                                                                <div class="d-flex align-items-center">
                                                                                    <div class="ms-3">
                                                                                        <p class="fw-bold mb-1"><?php echo $new['news_author']; ?></p>
                                                                                        <p class="text-muted mb-0"></p>
                                                                                    </div>
                                                                                </div>
                                                                            </td>
                                                                            <td>
                                                                                <div class="d-flex align-items-center">
                                                                                    <div class="ms-3">
                                                                                        <p class="fw-bold mb-1"><?php echo $new['publication_date']; ?></p>
                                                                                        <p class="text-muted mb-0"></p>
                                                                                    </div>
                                                                                </div>
                                                                            </td>
                                                                            ...
                                                                            <td>
                                                                                <a href="?action=editNews&news_id=<?php echo $new['id']; ?>"
                                                                                   id="edit_line"
